...
namespace BSolutions.Buttonboard.Scenario.Horrorhouse
{
    public class HorrorhouseScenario : ScenarioBase
    {
        ...
        protected override async Task RunScene1()
        {
            ...
            {
                _logger.LogInformation("Szene 1 wurde gestartet ...");
        ...
        protected override Task RunScene2()
        {
            return Task.Run(async () =>
            {
                ...
                {
                    _logger.LogInformation("Szene 2 wurde gestartet ...");
        ...
        protected override Task RunScene3()
        {
            return Task.Run(async () =>
            {
                ...
                {
                    _logger.LogInformation("Szene 3 wurde gestartet ...");
        ...
        protected override Task RunScene4()
        {
            return Task.Run(async () =>
            {
                ...
                {
                    _logger.LogInformation("Szene 4 wurde gestartet ...");
        ...
        private static async Task WaitUntilAsync(Stopwatch sw, int dueMs)
        {
